...
Hieraus ergebene sich 3 verschiedene Werte mit Fehler für $c_\mathrm{S}$, die gewichtet addiert werden um den finalen Wert
\[
	c_\mathrm{S} = \unit[(345.5 \pm 0.7)]{m/s}
\]
zu erhalten.

%TODO vergleich mit voreriger Aufgabe

Aus der Literatur%
\footnote{David R. Lide: Handbook of Chemistry and Physics, CRC Press, 85. Auflage, Seite 14-41}
erhalten wir Werte von $c_\mathrm{S}$ für $\unit[20]{ ^\circ C}$ und $\unit[25]{ ^\circ C}$. Interpolation liefert für unsere Temperatur von $\unit[22.8]{ ^\circ C}$ einen Wert von $\unit[345.02]{m/s}$, was, im Rahmen des Fehlers, mit unserem Wert überinstimmt.
