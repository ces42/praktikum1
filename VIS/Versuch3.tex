...
The graph of the measured values is shown in figure \ref{fig:aufgabe2}. With linear regression\footnote{Calculated by Origin} we get the following values and errors:
\begin{align*}
